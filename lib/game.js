  ...
  handleCollision() {
    this.shapes.forEach(shape => {
      if (this.player.radius - BALL_RADIUS <= shape.radius &&
        ...
        if (this.player.angle > start && this.player.angle < end ||
            this.player.angle - 360 > start && this.player.angle - 360 < end ||
            this.player.angle + 360 > start && this.playerangle + 360 < end) {
